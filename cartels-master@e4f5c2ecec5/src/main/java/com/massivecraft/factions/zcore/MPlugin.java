    ...
    public void loadLang() {
        ...
        if (!lang.exists()) {
            try {
                ...
                getLogger().severe("[Cartels] Couldn't create language file.");
                getLogger().severe("[Cartels] This is a fatal error. Now disabling");
        ...
        if (conf.getString(TL.COMMAND_SHOW_POWER.getPath(), "").contains("%5$s")) {
            ...
            log(Level.INFO, "Removed errant format specifier from c show power.");
        }
        ...
        try {
            ...
            getLogger().log(Level.WARNING, "Cartels: Failed to save lang.yml.");
            getLogger().log(Level.WARNING, "Cartels: Report this stack trace to drtshock.");
            e.printStackTrace();
        }
    }
