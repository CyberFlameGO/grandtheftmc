...
public enum TL {
     ...
     */
    COMMAND_ADMIN_NOTMEMBER("%1$s<i> is not a member in your cartel."),
    COMMAND_ADMIN_NOTADMIN("<b>You are not the cartel boss."),
    COMMAND_ADMIN_TARGETSELF("<b>The target player musn't be yourself."),
    COMMAND_ADMIN_DEMOTES("<i>You have demoted %1$s<i> from the position of cartel boss."),
    COMMAND_ADMIN_DEMOTED("<i>You have been demoted from the position of cartel boss by %1$s<i>."),
    COMMAND_ADMIN_PROMOTES("<i>You have promoted %1$s<i> to the position of cartel boss."),
    COMMAND_ADMIN_PROMOTED("%1$s<i> gave %2$s<i> the leadership of %3$s<i>."),
    COMMAND_ADMIN_DESCRIPTION("Hand over your boss rights"),

    COMMAND_AHOME_DESCRIPTION("Send a player to their cartel home no matter what."),
    COMMAND_AHOME_NOHOME("%1$s doesn't have a cartel home."),
    COMMAND_AHOME_SUCCESS("$1%s was sent to their cartel home."),
    COMMAND_AHOME_OFFLINE("%1$s is offline."),
    COMMAND_AHOME_TARGET("You were sent to your cartel home."),

    COMMAND_ANNOUNCE_DESCRIPTION("Announce a message to players in cartel."),
    ...
    COMMAND_BOOM_PEACEFULONLY("<b>This command is only usable by cartels which are specifically designated as peaceful."),
    COMMAND_BOOM_TOTOGGLE("to toggle explosions"),
    COMMAND_BOOM_FORTOGGLE("for toggling explosions"),
    COMMAND_BOOM_ENABLED("%1$s<i> has %2$s explosions in your cartel's territory."),
    COMMAND_BOOM_DESCRIPTION("Toggle explosions (peaceful cartels only)"),
    ...
    COMMAND_CHAT_INVALIDMODE("<b>Unrecognised chat mode. <i>Please enter either 'a','c' or 'p'"),//TODO Don't forget, change character to c for chatmode.
    ...
    COMMAND_CHAT_MODE_FACTION("<i>Cartel only chat mode."),
    ...
    COMMAND_CREATE_MUSTLEAVE("<b>You must leave your current cartel first."),
    COMMAND_CREATE_INUSE("<b>That tag is already in use."),
    COMMAND_CREATE_TOCREATE("to create a new cartel"),
    COMMAND_CREATE_FORCREATE("for creating a new cartel"),
    COMMAND_CREATE_ERROR("<b>There was an internal error while trying to create your cartel. Please try again."),
    COMMAND_CREATE_CREATED("%1$s<i> created a new cartel %2$s"),
    COMMAND_CREATE_YOUSHOULD("<i>You should now: %1$s"),
    COMMAND_CREATE_CREATEDLOG(" created a new cartel: "),
    COMMAND_CREATE_DESCRIPTION("Create a new cartel"),
    ...
    COMMAND_DELFWARP_DESCRIPTION("Delete a cartel warp"),

    COMMAND_DESCRIPTION_CHANGES("You have changed the description for <h>%1$s<i> to:"),
    COMMAND_DESCRIPTION_CHANGED("<i>The cartel %1$s<i> changed their description to:"),
    COMMAND_DESCRIPTION_TOCHANGE("to change cartel description"),
    COMMAND_DESCRIPTION_FORCHANGE("for changing cartel description"),
    COMMAND_DESCRIPTION_DESCRIPTION("Change the cartel description"),

    COMMAND_DISBAND_IMMUTABLE("<i>You cannot disband the Wilderness, SafeZone, or WarZone."),
    COMMAND_DISBAND_MARKEDPERMANENT("<i>This cartel is designated as permanent, so you cannot disband it."),
    COMMAND_DISBAND_BROADCAST_YOURS("<h>%1$s<i> disbanded your cartel."),
    COMMAND_DISBAND_BROADCAST_NOTYOURS("<h>%1$s<i> disbanded the cartel %2$s."),
    COMMAND_DISBAND_HOLDINGS("<i>You have been given the disbanded cartel's bank, totaling %1$s."),
    COMMAND_DISBAND_DESCRIPTION("Disband a cartel"),
    ...
    COMMAND_FWARP_DESCRIPTION("Teleport to a cartel warp"),

    COMMAND_HELP_404("<b>This page does not exist"),
    COMMAND_HELP_NEXTCREATE("<i>Learn how to create a cartel on the next page."),
    ...
    COMMAND_HELP_BANK_1("<i>Your cartel has a bank which is used to pay for certain"),
    ...
    COMMAND_HELP_OWNERSHIP_2("<i>that only the owner(s), cartel boss, and possibly the"),
    COMMAND_HELP_OWNERSHIP_3("<i>cartel underbosses have full access."),
    COMMAND_HELP_RELATIONS_1("<i>Set the relation you WISH to have with another cartel."),
    COMMAND_HELP_RELATIONS_2("<i>Your default relation with other cartels will be neutral."),
    COMMAND_HELP_RELATIONS_3("<i>If BOTH cartels choose \"ally\" you will be allies."),
    COMMAND_HELP_RELATIONS_4("<i>If ONE cartel chooses \"enemy\" you will be enemies."),
    ...
    COMMAND_HELP_RELATIONS_7("<i>You can always hurt enemies and players without cartel."),
    ...
    COMMAND_HELP_RELATIONS_11("<i>The power of a cartel is the sum of all member power."),
    COMMAND_HELP_RELATIONS_12("<i>The power of a cartel determines how much land it can hold."),
    COMMAND_HELP_RELATIONS_13("<i>You can claim land from cartels with too little power."),
    COMMAND_HELP_PERMISSIONS_1("<i>Only cartel members can build and destroy in their own"),
    ...
    COMMAND_HELP_ADMIN_1("<c>/c claim safezone <i>claim land for the Safe Zone"),
    COMMAND_HELP_ADMIN_2("<c>/c claim warzone <i>claim land for the War Zone"),
    COMMAND_HELP_ADMIN_3("<c>/c autoclaim [safezone|warzone] <i>take a guess"),
    ...
    COMMAND_HOME_DISABLED("<b>Sorry, Cartel homes are disabled on this server."),
    COMMAND_HOME_TELEPORTDISABLED("<b>Sorry, the ability to teleport to Cartel homes is disabled on this server."),
    COMMAND_HOME_NOHOME("<b>Your cartel does not have a home. "),
    COMMAND_HOME_INENEMY("<b>You cannot teleport to your cartel home while in the territory of an enemy cartel."),
    COMMAND_HOME_WRONGWORLD("<b>You cannot teleport to your cartel home while in a different world."),
    COMMAND_HOME_ENEMYNEAR("<b>You cannot teleport to your cartel home while an enemy is within %s blocks of you."),
    COMMAND_HOME_TOTELEPORT("to teleport to your cartel home"),
    COMMAND_HOME_FORTELEPORT("for teleporting to your cartel home"),
    COMMAND_HOME_DESCRIPTION("Teleport to the cartel home"),
    ...
    COMMAND_INVITE_INVITED("%1$s<i> invited %2$s<i> to your cartel."),
    COMMAND_INVITE_ALREADYMEMBER("%1$s<i> is already a member of %2$s"),
    COMMAND_INVITE_DESCRIPTION("Invite a player to your cartel"),

    COMMAND_JOIN_CANNOTFORCE("<b>You do not have permission to move other players into a cartel."),
    COMMAND_JOIN_SYSTEMFACTION("<b>Players may only join normal cartels. This is a system cartel."),
    COMMAND_JOIN_ALREADYMEMBER("<b>%1$s %2$s already a member of %3$s"),
    COMMAND_JOIN_ATLIMIT(" <b>!<white> The cartel %1$s is at the limit of %2$d members, so %3$s cannot currently join."),
    COMMAND_JOIN_INOTHERFACTION("<b>%1$s must leave %2$s current cartel first."),
    COMMAND_JOIN_NEGATIVEPOWER("<b>%1$s cannot join a cartel with a negative power level."),
    COMMAND_JOIN_REQUIRESINVITATION("<i>This cartel requires invitation."),
    COMMAND_JOIN_ATTEMPTEDJOIN("%1$s<i> tried to join your cartel."),
    COMMAND_JOIN_TOJOIN("to join a cartel"),
    COMMAND_JOIN_FORJOIN("for joining a cartel"),
    COMMAND_JOIN_SUCCESS("<i>%1$s successfully joined %2$s."),
    COMMAND_JOIN_MOVED("<i>%1$s moved you into the cartel %2$s."),
    COMMAND_JOIN_JOINED("<i>%1$s joined your cartel."),
    COMMAND_JOIN_JOINEDLOG("%1$s joined the cartel %2$s."),
    COMMAND_JOIN_MOVEDLOG("%1$s moved the player %2$s into the cartel %3$s."),
    COMMAND_JOIN_DESCRIPTION("Join a cartel"),
    ...
    COMMAND_KICK_NONE("That player is not in a cartel."),
    ...
    COMMAND_KICK_TOKICK("to kick someone from the cartel"),
    COMMAND_KICK_FORKICK("for kicking someone from the cartel"),
    COMMAND_KICK_FACTION("%1$s<i> kicked %2$s<i> from the cartel! :O"), //message given to cartel members
    COMMAND_KICK_KICKS("<i>You kicked %1$s<i> from the cartel %2$s<i>!"), //kicker perspective
    COMMAND_KICK_KICKED("%1$s<i> kicked you from %2$s<i>! :O"), //kicked player perspective
    COMMAND_KICK_DESCRIPTION("Kick a player from the cartel"),

    COMMAND_LIST_FACTIONLIST("Cartel List "),
    COMMAND_LIST_TOLIST("to list the cartels"),
    COMMAND_LIST_FORLIST("for listing the cartels"),
    COMMAND_LIST_ONLINEFACTIONLESS("Online cartelless: "),
    COMMAND_LIST_DESCRIPTION("See a list of the cartels"),

    COMMAND_LOCK_LOCKED("<i>Cartels is now locked"),
    COMMAND_LOCK_UNLOCKED("<i>Cartels in now unlocked"),
    COMMAND_LOCK_DESCRIPTION("Lock all write stuff. Apparently."),

    COMMAND_LOGINS_TOGGLE("<i>Set login / logout notifications for Cartel members to: <a>%s"),
    COMMAND_LOGINS_DESCRIPTION("Toggle(?) login / logout notifications for Cartel members"),
    ...
    COMMAND_MOD_NOTMEMBER("%1$s<b> is not a member in your cartel."),
    COMMAND_MOD_NOTADMIN("<b>You are not the cartel boss."),
    COMMAND_MOD_SELF("<b>The target player musn't be yourself."),
    COMMAND_MOD_TARGETISADMIN("<b>The target player is a cartel boss. Demote them first."),
    COMMAND_MOD_REVOKES("<i>You have removed underbos status from %1$s<i>."),
    COMMAND_MOD_REVOKED("%1$s<i> is no longer underbos in your cartel."),
    COMMAND_MOD_PROMOTES("%1$s<i> was promoted to underbos in your cartel."),
    COMMAND_MOD_PROMOTED("<i>You have promoted %1$s<i> to underbos."),
    COMMAND_MOD_DESCRIPTION("Give or revoke underbos rights"),

    COMMAND_MODIFYPOWER_ADDED("<i>Added <a>%1$f <i>power to <a>%2$s. <i>New total rounded power: <a>%3$d"),
    COMMAND_MODIFYPOWER_DESCRIPTION("Modify the power of a cartel/player"),

    COMMAND_MONEY_LONG("<i>The cartel money commands."),
    COMMAND_MONEY_DESCRIPTION("Cartel money commands"),

    COMMAND_MONEYBALANCE_SHORT("show cartel balance"),
    COMMAND_MONEYBALANCE_DESCRIPTION("Show your cartels current money balance"),

    COMMAND_MONEYDEPOSIT_DESCRIPTION("Deposit money"),
    COMMAND_MONEYDEPOSIT_DEPOSITED("%1$s deposited %2$s in the cartel bank: %3$s"),

    COMMAND_MONEYTRANSFERFF_DESCRIPTION("Transfer f -> f"),
    COMMAND_MONEYTRANSFERFF_TRANSFER("%1$s transferred %2$s from the cartel \"%3$s\" to the cartel \"%4$s\""),

    COMMAND_MONEYTRANSFERFP_DESCRIPTION("Transfer f -> p"),
    COMMAND_MONEYTRANSFERFP_TRANSFER("%1$s transferred %2$s from the cartel \"%3$s\" to the player \"%4$s\""),

    COMMAND_MONEYTRANSFERPF_DESCRIPTION("Transfer p -> f"),
    COMMAND_MONEYTRANSFERPF_TRANSFER("%1$s transferred %2$s from the player \"%3$s\" to the cartel \"%4$s\""),

    COMMAND_MONEYWITHDRAW_DESCRIPTION("Withdraw money"),
    COMMAND_MONEYWITHDRAW_WITHDRAW("%1$s withdrew %2$s from the cartel bank: %3$s"),

    COMMAND_OPEN_TOOPEN("to open or close the cartel"),
    COMMAND_OPEN_FOROPEN("for opening or closing the cartel"),
    COMMAND_OPEN_OPEN("open"),
    COMMAND_OPEN_CLOSED("closed"),
    COMMAND_OPEN_CHANGES("%1$s<i> changed the cartel to <h>%2$s<i>."),
    COMMAND_OPEN_CHANGED("<i>The cartel %1$s<i> is now %2$s"),
    ...
    COMMAND_OWNER_LIMIT("<b>Sorry, but you have reached the server's <h>limit of %1$d <b>owned areas per cartel."),
    COMMAND_OWNER_WRONGFACTION("<b>This land is not claimed by your cartel, so you can't set ownership of it."),
    COMMAND_OWNER_NOTCLAIMED("<b>This land is not claimed by a cartel. Ownership is not possible."),
    COMMAND_OWNER_NOTMEMBER("%1$s<i> is not a member of this cartel."),
    ...
    COMMAND_OWNERLIST_WRONGFACTION("<b>This land is not claimed by your cartel."),//eq
    COMMAND_OWNERLIST_NOTCLAIMED("<i>This land is not claimed by any cartel, thus no owners."),//eq
    COMMAND_OWNERLIST_NONE("<i>No owners are set here; everyone in the cartel has access."),
    ...
    COMMAND_PEACEFUL_DESCRIPTION("Set a cartel to peaceful"),
    COMMAND_PEACEFUL_YOURS("%1$s has %2$s your cartel"),
    COMMAND_PEACEFUL_OTHER("%s<i> has %s the cartel '%s<i>'."),
    COMMAND_PEACEFUL_GRANT("granted peaceful status to"),
    COMMAND_PEACEFUL_REVOKE("removed peaceful status from"),

    COMMAND_PERMANENT_DESCRIPTION("Toggles a cartel's permanence"), //TODO: Real word?
    COMMAND_PERMANENT_GRANT("added permanent status to"),
    COMMAND_PERMANENT_REVOKE("removed permanent status from"),
    COMMAND_PERMANENT_YOURS("%1$s has %2$s your cartel"),
    COMMAND_PERMANENT_OTHER("%s<i> has %s the cartel '%s<i>'."),

    COMMAND_PERMANENTPOWER_DESCRIPTION("Toggle cartel power permanence"), //TODO: This a real word?
    ...
    COMMAND_PERMANENTPOWER_FACTION("%s<i> %s your cartel"),
    ...
    COMMAND_POWERBOOST_HELP_1("<b>You must specify \"p\" or \"player\" to target a player or \"f\" or \"cartel\" to target a cartel."),
    COMMAND_POWERBOOST_HELP_2("<b>ex. /c powerboost p SomePlayer 0.5  -or-  /c powerboost c SomeCartel -5"),
    ...
    COMMAND_POWERBOOST_FACTION("Cartel \"%1$s\""),
    ...
    COMMAND_POWERBOOST_DESCRIPTION("Apply permanent power bonus/penalty to specified player or cartel"),
    ...
    COMMAND_RELATIONS_MUTUAL("<i>Your cartel is now %1$s<i> to %2$s"),
    COMMAND_RELATIONS_PEACEFUL("<i>This will have no effect while your cartel is peaceful."),
    COMMAND_RELATIONS_PEACEFULOTHER("<i>This will have no effect while their cartel is peaceful."),
    COMMAND_RELATIONS_DESCRIPTION("Set relation wish to another cartel"),
    ...
    COMMAND_SAVEALL_SUCCESS("<i>Cartels saved to disk!"),
    COMMAND_SAVEALL_DESCRIPTION("Save all data to disk"),

    COMMAND_SCOREBOARD_DESCRIPTION("Scoreboardy things"),

    COMMAND_SETFWARP_NOTCLAIMED("<i>You can only set warps in your cartel territory."),
    COMMAND_SETFWARP_LIMIT("<i>Your Cartel already has the max amount of warps set <a>(%1$d)."),
    ...
    COMMAND_SETFWARP_DESCRIPTION("Set a cartel warp"),

    COMMAND_SETHOME_DISABLED("<b>Sorry, Cartel homes are disabled on this server."),
    COMMAND_SETHOME_NOTCLAIMED("<b>Sorry, your cartel home can only be set inside your own claimed territory."),
    COMMAND_SETHOME_TOSET("to set the cartel home"),
    COMMAND_SETHOME_FORSET("for setting the cartel home"),
    COMMAND_SETHOME_SET("%1$s<i> set the home for your cartel. You can now use:"),
    COMMAND_SETHOME_SETOTHER("<b>You have set the home for the %1$s<i> cartel."),
    COMMAND_SETHOME_DESCRIPTION("Set the cartel home"),

    COMMAND_SETMAXVAULTS_DESCRIPTION("Set max vaults for a Cartel."),
    COMMAND_SETMAXVAULTS_SUCCESS("&aSet max vaults for &e%s &ato &b%d"),

    COMMAND_VAULT_DESCRIPTION("/c vault <number> to open one of your Cartel's vaults."),
    COMMAND_VAULT_TOOHIGH("&cYou tried to open vault %d but your Cartel only has %d vaults."),

    COMMAND_SHOW_NOFACTION_SELF("You are not in a cartel"),
    COMMAND_SHOW_NOFACTION_OTHER("That's not a cartel"),
    COMMAND_SHOW_TOSHOW("to show cartel information"),
    COMMAND_SHOW_FORSHOW("for showing cartel information"),
    COMMAND_SHOW_DESCRIPTION("<a>Description: <i>%1$s"),
    COMMAND_SHOW_PEACEFUL("This cartel is Peaceful"),
    COMMAND_SHOW_PERMANENT("<a>This cartel is permanent, remaining even with no members."),
    ...
    COMMAND_SHOW_COMMANDDESCRIPTION("Show cartel information"),
    COMMAND_SHOW_DEATHS_TIL_RAIDABLE("<i>DTR: %1$d"),
    COMMAND_SHOW_EXEMPT("<b>This cartel is exempt and cannot be seen."),

    COMMAND_SHOWINVITES_PENDING("Players with pending invites: "),
    COMMAND_SHOWINVITES_CLICKTOREVOKE("Click to revoke invite for %1$s"),
    COMMAND_SHOWINVITES_DESCRIPTION("Show pending cartel invites"),
    ...
    COMMAND_STUCK_DESCRIPTION("Safely teleports you out of enemy cartel"),

    COMMAND_TAG_TAKEN("<b>That tag is already taken"),
    COMMAND_TAG_TOCHANGE("to change the cartel tag"),
    COMMAND_TAG_FORCHANGE("for changing the cartel tag"),
    COMMAND_TAG_FACTION("%1$s<i> changed your cartel tag to %2$s"),
    COMMAND_TAG_CHANGED("<i>The cartel %1$s<i> changed their name to %2$s."),
    COMMAND_TAG_DESCRIPTION("Change the cartel tag"),
    ...
    COMMAND_TOP_DESCRIPTION("Sort Cartels to see the top of some criteria."),
    COMMAND_TOP_TOP("Top Cartels by %s. Page %d/%d"),
    COMMAND_TOP_LINE("%d. &6%s: &c%s"), // Rank. Cartel: Value
    ...
    COMMAND_UNCLAIM_LOG("%1$s unclaimed land at (%2$s) from the cartel: %3$s"),
    ...
    COMMAND_UNCLAIMALL_TOUNCLAIM("to unclaim all cartel land"),
    COMMAND_UNCLAIMALL_FORUNCLAIM("for unclaiming all cartel land"),
    COMMAND_UNCLAIMALL_UNCLAIMED("%1$s<i> unclaimed ALL of your cartel's land."),
    COMMAND_UNCLAIMALL_LOG("%1$s unclaimed everything for the cartel: %2$s"),
    COMMAND_UNCLAIMALL_DESCRIPTION("Unclaim all of your cartels land"),
     ...
     */
    LEAVE_PASSADMIN("<b>You must give the boss role to someone else first."),
    LEAVE_NEGATIVEPOWER("<b>You cannot leave until your power is positive."),
    LEAVE_TOLEAVE("to leave your cartel."),
    LEAVE_FORLEAVE("for leaving your cartel."),
    LEAVE_LEFT("%s<i> left cartel %s<i>."),
    LEAVE_DISBANDED("<i>%s<i> was disbanded."),
    LEAVE_DISBANDEDLOG("The cartel %s (%s) was disbanded due to the last player (%s) leaving."),
    LEAVE_DESCRIPTION("Leave your cartel"),
    ...
    CLAIM_MEMBERS("Cartels must have at least <h>%s<b> members to claim land."),
    ...
    CLAIM_CONTIGIOUS("<b>You can only claim additional land which is connected to your first claim or controlled by another cartel!"),
    CLAIM_FACTIONCONTIGUOUS("<b>You can only claim additional land which is connected to your first claim!"),
    CLAIM_PEACEFUL("%s<i> owns this land. Your cartel is peaceful, so you cannot claim land from other cartels."),
    CLAIM_PEACEFULTARGET("%s<i> owns this land, and is a peaceful cartel. You cannot claim land from them."),
    ...
    CLAIM_CLAIMEDLOG("%s claimed land at (%s) for the cartel: %s"),
    CLAIM_OVERCLAIM_DISABLED("<i>Over claiming is disabled on this server."),
    CLAIM_TOOCLOSETOOTHERFACTION("<i>Your claim is too close to another Cartel. Buffer required is %d"),
     ...
     */
    GENERIC_YOU("you"),
    GENERIC_YOURFACTION("your cartel"),
    ...
    GENERIC_DEFAULTDESCRIPTION("Default cartel description :("),
    GENERIC_OWNERS("Owner(s): %1$s"),
    GENERIC_PUBLICLAND("Public cartel land."),
    GENERIC_FACTIONLESS("cartelless"),
    ...
    GENERIC_ASKYOURLEADER("<i> Ask your boss to:"),
    ...
    GENERIC_FACTIONTAG_TOOSHORT("<i>The cartel tag can't be shorter than <h>%1$s<i> chars."),
    GENERIC_FACTIONTAG_TOOLONG("<i>The cartel tag can't be longer than <h>%s<i> chars."),
    GENERIC_FACTIONTAG_ALPHANUMERIC("<i>Cartel tag must be alphanumeric. \"<h>%s<i>\" is not allowed."),
    ...
    PLAYER_COMMAND_PERMANENT("<b>You can't use the command '%s' because you are in a permanent cartel."),
    ...
    PLAYER_POWER_NOLOSS_PEACEFUL("<i>You didn't lose any power since you are in a peaceful cartel."),
    ...
    PLAYER_PVP_REQUIREFACTION("<i>You can't hurt other players until you join a cartel."),
    PLAYER_PVP_FACTIONLESS("<i>You can't hurt players who are not currently in a cartel."),
    PLAYER_PVP_PEACEFUL("<i>Peaceful players cannot participate in combat."),
    PLAYER_PVP_NEUTRAL("<i>You can't hurt neutral cartels. Declare them as an enemy."),
    ...
    DEFAULT_PREFIX("default-prefix", "{relationcolor}[{cartel}] &r"),
