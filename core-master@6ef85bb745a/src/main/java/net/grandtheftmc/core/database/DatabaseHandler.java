package net.grandtheftmc.core.database;
...
import net.grandtheftmc.core.database.component.Database;
import net.grandtheftmc.core.database.component.DatabaseCredentials;
...
public class DatabaseHandler implements Database {
	 ...
	 * @param path - the path to load settings from
	 */
	public void init(YamlConfiguration config, String path) {
