 ...
 */
package net.grandtheftmc.core.wrapper.packet.out;
...
public class WrapperPlayServerWorldParticles extends AbstractPacket {
	 ...
	 */
	public WrapperPlayServerWorldParticles setParticleType(Particle value) {
	 ...
	 * @param value - new value.
	 */
	public WrapperPlayServerWorldParticles setX(float value) {
	 ...
	 * @param value - new value.
	 */
	public WrapperPlayServerWorldParticles setY(float value) {
	 ...
	 * @param value - new value.
	 */
	public WrapperPlayServerWorldParticles setZ(float value) {
	 ...
	 * @param value - new value.
	 */
	public WrapperPlayServerWorldParticles setData(int[] value) {
