...
import net.grandtheftmc.core.wrapper.packet.out.*;
...
public class DummyPacketGen {

    public static WrapperPlayServerNamedEntitySpawn getIdentityPlayerSpawnPacket(DummyIdentity id, int entityId, Location loc) {
    ...
    public static WrapperPlayServerSpawnEntityLiving getIdentityNotPlayerSpawnPacket(DummyIdentity id, int entityId, Location loc) {
    ...
    public static void sendSpawnPacket(Player p, DummyIdentity id, int entityId, Location loc) {
