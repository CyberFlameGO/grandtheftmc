 ...
 */
public class BankTellerNPC extends CoreNPC implements ClickableNPC, CollideableNPC {
    public BankTellerNPC(Location loc) {
        super(loc, EntityType.PLAYER, "&a&lSacha Goldman", "&7&oAccess your bank here!");
    }
