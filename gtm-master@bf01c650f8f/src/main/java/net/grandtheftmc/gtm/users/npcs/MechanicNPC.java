 ...
 */
public class MechanicNPC extends CoreNPC implements ClickableNPC, CollideableNPC {
    public MechanicNPC(Location loc) {
        super(loc, EntityType.PLAYER, "&a&lMechanic Gary", "&7&oRepair your vehicles here!");
    }
