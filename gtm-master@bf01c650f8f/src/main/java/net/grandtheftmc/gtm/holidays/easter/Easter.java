...
//        return GTMUtils.getMonth() == Month.APRIL && GTMUtils.getDay() == 15
//                || GTMUtils.getDay() == 16 || GTMUtils.getDay() == 17;
        return false;
    }
    ...
    public ItemStack getEasterEgg() {
        ...
        meta.setDisplayName(Utils.f(GTMUtils.randomColor() + "&lEaster Egg"));
    ...
    public ItemStack getChocolateBunny() {
        ...
        meta.setDisplayName(Utils.f(GTMUtils.randomColor() + "&lChocolate"));
