 ...
 */
public class NightStick extends MeleeWeapon implements WeaponVisualStatue {
    ...
    public NightStick() {
        super(
                ...
                new ItemFactory(Material.DIAMOND_SWORD).setDurability((short) 11).build(), //ItemStack
                new Sound[] { //Sounds
        ...
        setOldItemStack(new ItemFactory(Material.BLAZE_ROD).setName(getName()).build());
        setDescription("Enjoy trying to beat", "armed criminals to death.");
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(0.3, 1.1, -0.2), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -361.5, 25.5, 239.5, 0.0f, 0.0f);
    }
