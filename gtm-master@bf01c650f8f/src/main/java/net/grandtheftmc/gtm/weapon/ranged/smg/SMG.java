 ...
 */
public class SMG extends SMGWeapon implements WeaponVisualStatue {
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(0.2, -0.15, -0.35), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
        ...
        Location hookLoc = origin.clone().add(0, 1.05, -0.64);
        hookLoc.setPitch(0);
        hookLoc.setYaw(0);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -366.5, 25.5, 227.5, -90.0f, 0.0f);
    }
