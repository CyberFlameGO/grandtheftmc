 ...
 */
public class AssaultShotgun extends ShotgunWeapon implements WeaponVisualStatue {
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.35, 0.02, -0.1), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -376.5, 25.5, 237.5, 180.0f, 0.0f);
    }
