 ...
 */
public class BaseballBat extends MeleeWeapon implements WeaponVisualStatue {
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.3, 1.25, 0.125), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -370.5, 25.5, 228.5, 180.0f, 0.0f);
    }
