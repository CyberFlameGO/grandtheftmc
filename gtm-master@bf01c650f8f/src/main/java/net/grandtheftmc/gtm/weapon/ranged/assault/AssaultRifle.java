 ...
 */
public class AssaultRifle extends AssultRifleWeapon implements WeaponVisualStatue {
    /**
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.2, -0.16, 0.325), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -368.5, 25.5, 244.5, 90.0f, 0.0f);
    }
