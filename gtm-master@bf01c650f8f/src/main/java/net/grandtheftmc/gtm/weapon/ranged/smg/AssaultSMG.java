 ...
 */
public class AssaultSMG extends SMGWeapon implements WeaponVisualStatue {
    ...
    public AssaultSMG() {
        super(
                ...
                new ItemFactory(Material.DIAMOND_SWORD).setDurability((short) 121).build(), //ItemStack
        ...
        setOldItemStack(new ItemFactory(Material.IRON_PICKAXE).setName(getName()).build());
        setDescription("A solid,", "Military grade weapon.", "Good for mowing down enemies.");
        ...
        this.rpm = 460; //AssultRifleWeapon
        this.rps = 7;
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(0.2, -0.1, -0.4), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -365.5, 25.5, 227.5, -90.0f, 0.0f);
    }
