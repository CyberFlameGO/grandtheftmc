 ...
 */
public class CarbineRifle extends AssultRifleWeapon implements WeaponVisualStatue {
    /**
    ...
    public CarbineRifle() {
        super(
                ...
                new ItemFactory(Material.DIAMOND_SWORD).setDurability((short) 211).build(), //ItemStack
        ...
        setOldItemStack(new ItemFactory(Material.STONE_SPADE).setName(getName()).build());
        setDescription("A longer range version", "of your stock AR.");
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.2, -0.1, 0.35), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -369.5, 25.5, 244.5, 90.0f, 0.0f);
    }
