 ...
 */
public class GusenbergSweeper extends SMGWeapon implements RankedWeapon, WeaponVisualStatue {
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(0.2, -0.06, -0.4), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
        ...
        Location hookLoc = origin.clone().add(0.01, 1.22, -0.75);
        hookLoc.setPitch(0);
        hookLoc.setYaw(0);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -363.5, 25.5, 227.5, -90.0f, 0.0f);
    }
