 ...
 */
public class SawedoffShotgun extends ShotgunWeapon implements WeaponVisualStatue {
    ...
    public SawedoffShotgun() {
        ...
        //this.accuracy = 0.04; //RangedWeapon
        this.accuracy = 0.18; //RangedWeapon
        this.magSize = 2; //RangedWeapon
        this.reloadTime = 20; //RangedWeapon
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.35, -0.2, -0.2), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -376.5, 25.5, 240.5, 180.0f, 0.0f);
    }
