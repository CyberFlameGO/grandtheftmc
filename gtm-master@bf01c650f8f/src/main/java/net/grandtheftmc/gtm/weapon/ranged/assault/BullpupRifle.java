 ...
 */
public class BullpupRifle extends AssultRifleWeapon implements WeaponVisualStatue {
    /**
    ...
    public BullpupRifle() {
        super(
                ...
                new ItemFactory(Material.DIAMOND_SWORD).setDurability((short) 221).build(), //ItemStack
        ...
        setOldItemStack(new ItemFactory(Material.STONE_PICKAXE).setName(getName()).build());
        setDescription("It's a bit like the", "normal AR, but Chinese..", "很好！");
    ...
    public Location spawnVisual(World world) {
        ...
        ArmorStand weapon = spawnEntity(origin.clone().add(-0.2, -0.08, 0.4), this, WeaponVisualStatue.VisualType.NONE);
        weapon.setArms(true);
...
//        hook.setMarker(true);
    ...
    public Location getOrigin(World world) {
        return new Location(world, -370.5, 25.5, 244.5, 90.0f, 0.0f);
    }
