 ...
 */
public class SMGWeapon extends RangedWeapon<SMGWeapon> implements WeaponRPM {
     ...
     */
    public SMGWeapon(short uniqueIdentifier, String name, WeaponType weaponType, AmmoType ammoType, ItemStack itemStack, Sound[] sounds, Effect effect) {
    ...
    @Override
    public SMGWeapon clone() {
        SMGWeapon weapon = new SMGWeapon(getUniqueIdentifier(), getName(), getWeaponType(), getAmmoType(), getBaseItemStack().clone(), getSounds(), getEffect());
