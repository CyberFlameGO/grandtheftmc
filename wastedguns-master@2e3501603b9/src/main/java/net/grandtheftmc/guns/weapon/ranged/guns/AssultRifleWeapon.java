 ...
 */
public class AssultRifleWeapon extends RangedWeapon<AssultRifleWeapon> implements WeaponRPM {
     ...
     */
    public AssultRifleWeapon(short uniqueIdentifier, String name, WeaponType weaponType, AmmoType ammoType, ItemStack itemStack, Sound[] sounds, Effect effect) {
    ...
    @Override
    public AssultRifleWeapon clone() {
        AssultRifleWeapon weapon = new AssultRifleWeapon(getUniqueIdentifier(), getName(), getWeaponType(), getAmmoType(), getBaseItemStack().clone(), getSounds(), getEffect());
