...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable {
     ...
     */
    public ArmorEquipEvent(final Player player, final EquipMethod equipType, final EquipArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
        super(player);
