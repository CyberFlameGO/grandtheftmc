package net.grandtheftmc.vice.drugs.items;
...
public class DrugItem {
    ...
    private final static DrugService drugService = (DrugService) Vice.getDrugManager().getService();
    ...
    public final static DrugItem getByItemStack(ItemStack itemStack) {
        ...
        if (drugService.getDrugs().stream().anyMatch(base::isValid) || drugService.getItems().contains(base))
            return base;
        return null;
    }
