...
public class DrugUtil {
    private static Collection<Material> ignoreBlocks = Arrays.asList(Material.AIR, Material.SIGN, Material.SIGN_POST,
    ...
    /*ublic static void sendWorldEnvironment(Player player, World.Environment environment) {
        ...
        int viewDistance = Vice.getInstance().getServer().getViewDistance();
        ...
        for (int x = location.getBlockX() - radius ; x <= location.getBlockX() + radius ; x++) {
            for (int z = location.getBlockZ() - radius ; z <= location.getBlockZ() + radius ; z++) {
                for(int y = location.getBlockY() - radius ; y <= location.getBlockY() + radius; y++) {
                    ...
                    if (!block.isEmpty() && !ignoreBlocks.contains(block.getType())) {
                        blocks.add(block);
                    }
                }
            }
