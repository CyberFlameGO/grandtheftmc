...
import net.grandtheftmc.vice.machine.recipe.type.RecipeWeed;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuWeed extends RecipeMenu {

    public RecipeMenuWeed() {
        super(3, "Recipe : Drying Chamber", new RecipeWeed(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
