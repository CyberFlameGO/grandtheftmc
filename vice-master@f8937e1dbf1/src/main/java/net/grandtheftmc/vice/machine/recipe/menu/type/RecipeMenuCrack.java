...
import net.grandtheftmc.vice.machine.recipe.type.RecipeCrack;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuCrack extends RecipeMenu {

    public RecipeMenuCrack() {
        super(3, "Recipe : Coca Processor", new RecipeCrack(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
