...
import net.grandtheftmc.vice.machine.recipe.type.RecipeBeer;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuBeer extends RecipeMenu {

    public RecipeMenuBeer() {
        super(3, "Recipe : Beer Distillery", new RecipeBeer(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
