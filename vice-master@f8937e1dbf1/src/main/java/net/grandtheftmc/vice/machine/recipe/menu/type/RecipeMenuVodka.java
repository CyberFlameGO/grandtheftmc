...
import net.grandtheftmc.vice.machine.recipe.type.RecipeVodka;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuVodka extends RecipeMenu {

    public RecipeMenuVodka() {
        super(3, "Recipe : Vodka Distillery", new RecipeVodka(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
