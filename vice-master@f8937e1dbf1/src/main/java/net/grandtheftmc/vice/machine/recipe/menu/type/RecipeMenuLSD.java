...
import net.grandtheftmc.vice.machine.recipe.type.RecipeLSD;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuLSD extends RecipeMenu {

    public RecipeMenuLSD() {
        super(3, "Recipe : Sugar Box", new RecipeLSD(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
