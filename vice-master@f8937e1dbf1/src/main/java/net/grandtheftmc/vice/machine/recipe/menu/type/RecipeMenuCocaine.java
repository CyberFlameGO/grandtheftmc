...
import net.grandtheftmc.vice.machine.recipe.type.RecipeCocaine;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuCocaine extends RecipeMenu {

    public RecipeMenuCocaine() {
        super(3, "Recipe : Coca Processor", new RecipeCocaine(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
