...
import net.grandtheftmc.vice.machine.recipe.type.RecipeWhiteMeth;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuWhiteMeth extends RecipeMenu {

    public RecipeMenuWhiteMeth() {
        super(3, "Recipe : Meth Producer", new RecipeWhiteMeth(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
