...
import net.grandtheftmc.vice.machine.recipe.type.RecipeAcid;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuAcid extends RecipeMenu {

    public RecipeMenuAcid() {
        super(3, "Recipe : Drying Chamber", new RecipeAcid(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
