...
import net.grandtheftmc.vice.machine.recipe.type.RecipeDistilledVodka;
import org.bukkit.Material;
import org.bukkit.enchantments.Enchantment;
import org.bukkit.inventory.ItemFlag;

public final class RecipeMenuDistilledVodka extends RecipeMenu {

    public RecipeMenuDistilledVodka() {
        super(3, "Recipe : Vodka Distillery", new RecipeDistilledVodka(), CoreMenuFlag.RESET_CURSOR_ON_OPEN, CoreMenuFlag.CLOSE_ON_NULL_CLICK);
    ...
    public void initDurabilityItems() {
        String[] lore = {
