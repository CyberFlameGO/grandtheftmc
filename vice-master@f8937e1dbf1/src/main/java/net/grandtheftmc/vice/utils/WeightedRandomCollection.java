 ...
 * 
 * vice can not be copied and/or distributed without the express
...
public class WeightedRandomCollection<E> {
    ...
    /**
     * Add an items to the random collection with the
     * specified weight
     *
     * @param weight the weight (relative to the others)
     * @param result the items that corresponds to this weight
     */
    ...
    /**
     * Select a random items from the list based on the chance
