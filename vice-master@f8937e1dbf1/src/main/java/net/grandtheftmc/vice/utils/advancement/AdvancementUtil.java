...
public class AdvancementUtil {
    ...
    private AdvancementUtil(NamespacedKey id, String parent, String icon, String background, TextComponent title, TextComponent description, FrameType frame, boolean announce, boolean toast, boolean hidden, int counter, Set<Trigger.TriggerBuilder> triggers) {
        this.id = id;
        this.parent = parent;
        this.icon = icon;
    ...
    public AdvancementUtil show(JavaPlugin plugin, Player... players) {
        add();
        grant(players);
    ...
    public AdvancementUtil grant(Player... players) {
    ...
    public AdvancementUtil revoke(Player... players) {
        Advancement advancement = getAdvancement();
        for (Player player : players) {
            if (player.getAdvancementProgress(advancement).isDone()) {
    ...
    public static class AdvancementAPIBuilder {
        ...
        public AdvancementUtil build() {
            ...
            return new AdvancementUtil(id, parent, icon, background, title, description, frame, announce, toast, hidden, counter, triggers);
        }

        public String toString() {
            return "AdvancementAPI.AdvancementAPIBuilder(id=" + this.id + ", parent=" + this.parent + ", icon=" + this.icon + ", background=" + this.background + ", title=" + this.title + ", description=" + this.description + ", frame=" + this.frame + ", announce=" + this.announce + ", toast=" + this.toast + ", hidden=" + this.hidden + ", counter=" + this.counter + ", triggers=" + this.triggers + ")";
        }
    }
