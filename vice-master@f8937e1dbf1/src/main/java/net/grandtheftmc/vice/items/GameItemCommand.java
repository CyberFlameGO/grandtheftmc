...
//        Player player = (Player) s;
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "addweapon": {
                ...
                Optional<Weapon<?>> w = Vice.getWastedGuns().getWeaponManager().getWeapon(args[2]);
            ...
            case "adddrug": {
                ...
                Optional<Drug> drug = ((DrugService) Vice.getInstance().getDrugManager().getService()).getDrug(args[2]);
                if (drug.isPresent()) {
            ...
            case "addvehicle": {
                ...
                Optional<VehicleProperties> v = Vice.getWastedVehicles().getVehicle(args[2]);
...
//            }
            ...
            case "list":
                List<GameItem> items = Vice.getItemManager().getItems();
                int page = 1;
                if (args.length > 1) {
                    try {
                ...
                return true;
            case "load":
                Vice.getSettings().setItemsConfig(Utils.loadConfig("items"));
                Vice.getItemManager().loadItems();
                s.sendMessage(Lang.GAMEITEMS.f("&7Loaded GameItems!"));
                return true;
            case "save":
                Vice.getItemManager().saveItems();
