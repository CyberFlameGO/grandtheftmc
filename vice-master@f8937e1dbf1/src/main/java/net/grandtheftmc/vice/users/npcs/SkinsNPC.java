...
import net.grandtheftmc.vice.weapon.skins.menu.MainMenu;

public class SkinsNPC extends CoreNPC implements ClickableNPC {
    ...
    protected void generateNewNPC() {
        this.setLookClose(true);
        this.setSkin(
                "",
