package net.grandtheftmc.slack.attachment;
...
import net.grandtheftmc.slack.action.SlackAction;
...
public class SlackAttachment {
    ...
    private static final String STAMP = "ts";
    ...
    public JsonObject toJson() {
        ...
        if(footer != null) {
            ...
            data.addProperty(STAMP, System.currentTimeMillis());
        }
